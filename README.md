...
## Установка на iOS (ярлык на экран Домой)
- Откройте WishShare в Safari или Chrome на iPhone/iPad.
- Нажмите кнопку `iOS: На экран Домой` в блоке установки (или откройте меню `Поделиться`).
- Выберите `На экран Домой` и подтвердите добавление.

После установки приложение запускается в отдельном standalone-окне, как обычное iOS-приложение.
